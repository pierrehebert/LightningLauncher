...
public class ServerManagedPolicy implements Policy {
    ...
    private static final String PREF_LAST_RESPONSE = "d";
    private static final String PREF_VALIDITY_TIMESTAMP = "e";
    private static final String PREF_RETRY_UNTIL = "b";
    private static final String PREF_MAX_RETRIES = "c";
    private static final String PREF_RETRY_COUNT = "a";
    private static final String DEFAULT_VALIDITY_TIMESTAMP = "0";
    private static final String DEFAULT_RETRY_UNTIL = "0";
    private static final String DEFAULT_MAX_RETRIES = "5";
    ...
    public ServerManagedPolicy(Context context) {
        // Import old values
        mPreferences = new JSONDataObfuscator(context);
    ...
    public void processServerResponse(int response, ResponseData rawData) {
        ...
        if (response != Policy.RETRY && response != Policy.NO_SERVICE) {
            setRetryCount(0);
        } else {
