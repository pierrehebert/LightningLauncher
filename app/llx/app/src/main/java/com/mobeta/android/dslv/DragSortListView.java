...
public class DragSortListView extends ListView {
     ...
     */
    private float mFloatAlpha = 0.7f;
    ...
    private boolean updatePositions() {
        ...
        if (mAnimate) {
            ...
            if (mFloatViewMid < slideEdgeTop) {
                ...
                if(mDragState == DRAGGING && mDragListener != null) mDragListener.onItemHovered(itemPos + (itemPos>mSrcPos ? 0 : -1));
            } else if (mFloatViewMid < slideEdgeBottom) {
                mFirstExpPos = itemPos;
                mSecondExpPos = itemPos;
                if(mDragState == DRAGGING && mDragListener != null) mDragListener.onItemHovered(-1);
            } else {
                mFirstExpPos = itemPos;
                ...
                // Log.d("mobeta",
                // "firstExp="+mFirstExpPos+" secExp="+mSecondExpPos+" slideFrac="+mSlideFrac);
                if(mDragState == DRAGGING && mDragListener != null) mDragListener.onItemHovered(itemPos + (itemPos>=mSrcPos ? 1 : 0));
            }
